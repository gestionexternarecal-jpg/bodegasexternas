...
if (-not $downloadBase) {
    $downloadBase = "https://github.com/gestionexternarecal-jpg/bodegasexternas/releases/latest/download"
}
$downloadBase = $downloadBase.TrimEnd('/')
# Si la base usa /latest/download, el instalador queda en la ultima release publicada.
$downloadUrl = "$downloadBase/$setupName"
...
# UTF-8 sin BOM (evita fallos al parsear en la app).
