...
Edita `dart_defines.json` con tus valores **reales** de Odoo y las URLs de GitHub.
Para la **primera** version `1.0.0` en `pubspec.yaml`, usa el tag `v1.0.0`:

```json
{
  "ODOO_BASE_URL": "https://tu-servidor.odoo.com",
  "ODOO_DATABASE": "tu_base",
  "UPDATE_MANIFEST_URL": "https://github.com/gestionexternarecal-jpg/bodegasexternas/releases/download/v1.0.0/version.json",
  "UPDATE_DOWNLOAD_BASE_URL": "https://github.com/gestionexternarecal-jpg/bodegasexternas/releases/download/v1.0.0/"
}
```

El tag del release (`v1.0.0`) debe coincidir con la carpeta de la URL.
